...
Point the user at the sibling **maintain-verification-skill** skill for keeping the map honest as the app changes. Suggest a cadence only if they ask.
