...
Start by finding the relevant code. Use the host's file search to find directories and files, text or symbol search to find key symbols, and file-read capability to understand the actual implementation. Don't guess from names. Read the code.
